...
namespace ReadingPDFConcept
{
    class Program
    {
        static PDFNetLoader _pdfNetLoader = PDFNetLoader.Instance();
        // adding comment to scync
        static void Main(string[] args)
        {
            ...
            var input_path = AppContext.BaseDirectory + "/";

            try
            {
                using (PDFDoc doc = new PDFDoc(input_path + "EpoxyTanksDatabase.pdf"))
                {
